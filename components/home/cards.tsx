        ...
        <div>
          ...
          <div className="rounded-none border shadow-lg bg-white lg:w-[310px] sm:[250px] -mt-3 contrast-200 ml-auto px-4 lg:h-[190px] sm:h-auto">
            ...
            <p className="text-base text-Gray font-normal">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facilis, omnis fuga consectetur minus suscipit,
              nulla porro, sit deleniti nostrum labore tempora laboriosam{' '}
            </p>
            <div className="mt-2 text-darkLight">
              <a href="#">
                Find Out More
                <Image src="/svg/arrow.svg" width="20px" height="10px" />
              </a>
            </div>
          </div>
        </div>
